...
const LightIcon = (props: SvgProps) => (
  <Svg
    ...
    <G fill="#94989b">
      <Path d="m39.2 50-13.3 3.6v1.9l13.3-3.7zM26.9 57.3h10.3v1.8H26.9z" />
    </G>
    <Path fill="#616466" d="M26.9 55.5h10.3v1.8H26.9z" />
    <Path fill="#94989b" d="m38.2 53.6-11.3 3.7v1.9l11.3-3.7z" />
  </Svg>
);
